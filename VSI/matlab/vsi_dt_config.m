...
function vsi_dt_config(this_block)
  ...
  % Revision History:
  %
  %   05-Dec-2024  (12:10 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     D:\MarcosGomez\VSI\vsivivado\project_1\project_1.srcs\sources_1\new\vsi_dt.v
  %
  %
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('vsivivado/project_1/project_1.srcs/sources_1/new/vsi_dt.v');
  this_block.addFile('vsivivado/dead_time.v');
  this_block.addFile('vsivivado/pwm.v');
  this_block.addFile('vsivivado/pwm_deadtime.v');
