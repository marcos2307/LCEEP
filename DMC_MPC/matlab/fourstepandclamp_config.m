...
function fourstepandclamp_config(this_block)
  ...
  % Revision History:
  %
  %   22-Dec-2023  (15:56 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     D:\test1\fourstepandclamp.v
  %
  %
  ...
  this_block.addSimulinkInport('int_limit');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('int_limit').width ~= 16);
      this_block.setError('Input data type for port "int_limit" must have width=16.');
    end
